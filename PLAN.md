...
- [ ] Vite + React + TS + Router, FSD структура, Zustand-сторы (auth/surveys/ui), axios/fetch клиент с типами из packages/shared

### Эпик 8 — Frontend: аутентификация и профиль

- [ ] Регистрация/логин формы (react-hook-form + zod), защищённые роуты
- [ ] Профиль: мои опросы / где я участник / друзья / группы

### Эпик 9 — Frontend: создание/редактирование опроса

- [ ] Конструктор опроса (вопросы, варианты, required, тип анонимности, allowMultipleSubmissions)
- [ ] Управление шерингом (пользователи/ссылка/группа)
